...
1-test_accuracy(Valid_IBS[,43],impute_cluster20)
...
# test_accuracy(Train_IBS[,43],imput_fitted30)
```
...
test_accuracy(Valid_IBS40[,43],impute_test40$fitted_values)
test_accuracy(Valid_IBS[,43],impute_test40$fitted_values)
```
...
#imput_fitted <- factor(imput_model$clusters,labels = c(0,1))
#manually change cluster sets
# IBS60_clusters <- factor(imput_model60$clusters,labels = c(2,1))
# test_accuracy(Train_IBS60[,43],IBS60_clusters)
```
...
test_accuracy(Valid_IBS50[,43],test_cluster50)
```
test accuracy of partial_km is 0.8833333
...
#test_accuracy(Valid_IBS50[,43],test_cluster50)
```
test accuracy of partial_km is 0.875
...
#test_accuracy(Valid_IBS50[,43],impute_cluster50)
```
test_accuracy of ClustImpute is 0.7333333
...
#test_accuracy(Valid_IBS[,43],partial_test90$fitted_values)
# test with 40% missing data
#test_accuracy(Valid_IBS50[,43],test_cluster50)
```
test accuracy of partial_km is 0.7583333
...
#test_accuracy(Valid_IBS50[,43],impute_cluster50)
```
test_accuracy of ClustImpute is 0.6833333
